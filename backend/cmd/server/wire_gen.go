...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	copilotTokenProvider := service.NewCopilotTokenProvider(httpUpstream)
	copilotGatewayService := service.NewCopilotGatewayService(httpUpstream, copilotTokenProvider, rateLimitService, configConfig)
	copilotGatewayHandler := handler.NewCopilotGatewayHandler(copilotGatewayService, gatewayService, concurrencyService, billingCacheService, apiKeyService, usageRecordWorkerPool)
	...
	handlers := handler.ProvideHandlers(authHandler, userHandler, apiKeyHandler, usageHandler, redeemHandler, subscriptionHandler, announcementHandler, adminHandlers, gatewayHandler, openAIGatewayHandler, copilotGatewayHandler, handlerSettingHandler, totpHandler, handlerPaymentHandler, paymentWebhookHandler, idempotencyCoordinator, idempotencyCleanupService)
